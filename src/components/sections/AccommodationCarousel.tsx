  ...
  return (
    <section className="relative w-full font-sans">
      <div className="absolute inset-y-0 left-4 z-20 flex items-center md:left-8">
        <button
          onClick={() => scroll("left")}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#304439] text-[#FFD2A2] shadow-lg transition hover:brightness-110"
        >
      ...
      >
        <div className="w-full shrink-0 snap-center bg-[#FAF9F6] py-24">
          <div className="mx-auto flex max-w-7xl flex-col gap-12 px-8 md:flex-row md:items-center md:px-24">
        ...
        <div className="w-full shrink-0 snap-center bg-[#FFD2A2] py-24">
          <div className="mx-auto flex max-w-7xl flex-col gap-12 px-8 md:flex-row md:items-center md:px-24">
            <div className="relative h-[600px] w-full flex-1 overflow-hidden rounded-xl shadow-xl md:h-[800px]">
              <img
