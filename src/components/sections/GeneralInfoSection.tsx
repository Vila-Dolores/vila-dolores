          ...
          <ul className="flex flex-col gap-6">
            <li className="flex items-start gap-4">
              ...
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Localização:</strong> a 500 metros da praia — dá pra ir caminhando tranquilamente
              </p>
            </li>
            <li className="flex items-start gap-4">
              <Car className="mt-1 h-6 w-6 shrink-0 text-[#FFD2A2]" />
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Estacionamento:</strong> 1 vaga exclusiva por casa
              </p>
            </li>
            <li className="flex items-start gap-4">
              <Wifi className="mt-1 h-6 w-6 shrink-0 text-[#FFD2A2]" />
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Conectividade:</strong> Wi-Fi disponível em todas as unidades (ótimo para trabalho remoto ou streaming)
              </p>
            </li>
            <li className="flex items-start gap-4">
              <ShieldCheck className="mt-1 h-6 w-6 shrink-0 text-[#FFD2A2]" />
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Segurança:</strong> área externa monitorada por câmeras 24h, fechadura com senha
              </p>
            </li>
            <li className="flex items-start gap-4">
              <Droplets className="mt-1 h-6 w-6 shrink-0 text-[#FFD2A2]" />
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Chuveirão:</strong> externo com lava-pés
              </p>
            </li>
            <li className="flex items-start gap-4">
              <Clock className="mt-1 h-6 w-6 shrink-0 text-[#FFD2A2]" />
              <p className="font-sans text-lg font-medium leading-relaxed text-white/90">
                <strong className="text-[#FFD2A2]">Horários:</strong> Check-in: 15h / Check-out: 11h
              </p>
            </li>
          </ul>
        </div>
